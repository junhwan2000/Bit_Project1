...
<%
	if( memId == null ) {
		// 로그인 안 된 메인
		%>
		<button type="button" class="btn btn-outline-dark" onclick="location='logonloginform.do'">로그인</button>
	    <button type="button" class="btn btn-outline-dark" onclick="location='logoninputform.do'">회원가입</button>
	    		&nbsp;
		<%
	} else {
		// 로그인 된 메인
		%>
		<button type="button" class="btn btn-outline-dark" onclick="location='logonlogout.do'">로그아웃</button>
	...
	if( memId == null ) {
		%>
			<p class="d-inline-flex gap-1">
			  <button type="button" class="btn btn-primary" data-bs-toggle="button" onclick="location='logonloginform.do'">
			  	로그인
